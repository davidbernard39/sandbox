...
public class UnitTest {
    ...
    public void should_predict_next_position_when_no_move() throws Exception {
        Reaper reaper = new Reaper(new Position(0,0), 400,1.5f, 0, 0,new GamePlayer(false,0, 0));
    ...
    public void should_predict_next_position_when_moving_without_initial_speed() throws Exception {
        Reaper reaper = new Reaper(new Position(4080,950), 400,1.5f, 0, 0,new GamePlayer(false,0, 0));
    ...
    public void should_predict_next_position_when_moving_with_initial_speed() throws Exception {
        Reaper reaper = new Reaper(new Position(4114,1147), 400,1.5f, 24, 138,new GamePlayer(false,0, 0));
